execute in minecraft:overworld run worldborder add 66.0 10
execute in minecraft:the_nether run worldborder add 66.0 10
execute in minecraft:the_end run worldborder add 66.0 10
