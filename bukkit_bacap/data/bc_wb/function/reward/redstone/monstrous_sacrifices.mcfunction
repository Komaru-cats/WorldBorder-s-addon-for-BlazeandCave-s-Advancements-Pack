execute in minecraft:overworld run worldborder add 53.0 9
execute in minecraft:the_nether run worldborder add 53.0 9
execute in minecraft:the_end run worldborder add 53.0 9
