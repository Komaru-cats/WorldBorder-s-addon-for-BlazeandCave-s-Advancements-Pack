execute in minecraft:overworld run worldborder add 18.0 6
execute in minecraft:the_nether run worldborder add 18.0 6
execute in minecraft:the_end run worldborder add 18.0 6
