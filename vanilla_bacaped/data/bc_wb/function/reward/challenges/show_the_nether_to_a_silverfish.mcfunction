execute in minecraft:overworld run worldborder add 170.0 15
execute in minecraft:the_nether run worldborder add 170.0 15
execute in minecraft:the_end run worldborder add 170.0 15
