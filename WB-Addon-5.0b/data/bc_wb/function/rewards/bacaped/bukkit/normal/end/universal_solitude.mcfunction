execute in minecraft:overworld run worldborder add 42.0 8
execute in minecraft:the_nether run worldborder add 42.0 8
execute in minecraft:the_end run worldborder add 42.0 8
