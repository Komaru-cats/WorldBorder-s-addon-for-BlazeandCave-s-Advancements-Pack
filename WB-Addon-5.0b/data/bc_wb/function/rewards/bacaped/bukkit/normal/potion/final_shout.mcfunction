execute in minecraft:overworld run worldborder add 1.6 2
execute in minecraft:the_nether run worldborder add 1.6 2
execute in minecraft:the_end run worldborder add 1.6 2
