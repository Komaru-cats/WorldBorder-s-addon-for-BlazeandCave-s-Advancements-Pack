execute in minecraft:overworld run worldborder set 59999968.0 2583
execute in minecraft:the_nether run worldborder set 59999968.0 2583
execute in minecraft:the_end run worldborder set 59999968.0 2583
