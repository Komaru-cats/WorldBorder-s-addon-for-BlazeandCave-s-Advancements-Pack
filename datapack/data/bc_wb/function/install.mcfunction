...
execute if score first_time wb matches 0 run scoreboard objectives add wb_config dummy
...
execute if score first_time wb matches 0 run scoreboard players set fast_wb wb_config 0
