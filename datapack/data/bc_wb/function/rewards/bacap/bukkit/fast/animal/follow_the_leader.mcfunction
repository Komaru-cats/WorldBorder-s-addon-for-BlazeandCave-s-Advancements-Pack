execute in minecraft:overworld run worldborder add 31.0
execute in minecraft:the_nether run worldborder add 31.0
execute in minecraft:the_end run worldborder add 31.0
