execute in minecraft:overworld run worldborder add 0.45 1
execute in minecraft:the_nether run worldborder add 0.45 1
execute in minecraft:the_end run worldborder add 0.45 1
