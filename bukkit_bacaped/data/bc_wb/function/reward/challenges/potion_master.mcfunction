execute in minecraft:overworld run worldborder add 120.0 13
execute in minecraft:the_nether run worldborder add 120.0 13
execute in minecraft:the_end run worldborder add 120.0 13
